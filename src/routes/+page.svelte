  ...
  <div class="contain">
    <ul class="slider">
      ...
      {#each firstHalf as member}
        <li class="person-card">
          {#if member.mugshot}
            <img class="animation-scale-out" src="https://fdnd.directus.app/assets/{member.mugshot}?width=500&height=500" alt="foto van {member.name}"/>
          {:else}
            <img class="animation-scale-out" src="https://avatars.githubusercontent.com/u/89637532?s=200&v=4" alt="MONKE" width=250 height=250/> 
          {/if}
