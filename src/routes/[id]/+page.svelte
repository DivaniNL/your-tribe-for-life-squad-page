...
<div class="grid-wrapper">
    ...
    {#if member.mugshot}
        <img
            ...
            width="250"
            height="250"
            style="view-transition-name: person-{member.id}"
        />
    {:else}
        <img
    ...
    <div class="info-container">
        ...
        {#if member.github_handle || member.website}
            <article
                class="basic-card user-links animation-slide-in--up"
                style="--delay: 0.2s;"
            >
                <h3>Links</h3>
    ...
    <ul class="favo-slider">
        {#each filters as filter, i}
            {#if member[filter[0]]}
                <li
                    class="basic-card favo-card animation-slide-in--up"
                    style="--delay: {i * 0.2 + 0.2}s;"
                >
